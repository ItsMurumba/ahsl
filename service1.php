...
<link rel="shortcut icon" href="style/images/logo.png.png">
<title>Our Services|AHSL</title>
<!-- Bootstrap core CSS -->
...
<main class="body-wrapper">
  ...
  <div class="light-wrapper">
    ...
    <div class="container inner2">
      <h2 class="post-title">EMR Expertise </h2>
      <div class="small-quote">
        <blockquote>
      <p>
        Our niche expertise is in the establishment of and capacity building on strategic information systems utilizing open source platforms specifically IQCare and Open MRS EMR for patient monitoring and management. We will enable you to do more for less by enhancing data quality for better services allowing you to extract more from your resources.
        Our EMR implementation and public health experts have had several years experience implementing EMR solutions for several PEPFAR funded programs including within Nairobi County.  We will undertake a collaborative approach involving county health and health facility managers at every stage of the process as this ensures overall success of the project.
        We can offer two approaches, a fully paperless system, or a hybrid of paper based and EMR. We can train and oversee EMR utilization by the County's own health records officers ensuring sustainability of health records management.
      </p>
        </blockquote>
        </div>
    </div>
