...
<main class="body-wrapper">
    ...
    <div class="light-wrapper">
        ...
        <div class="container inner2">
            <h2 class="post-title">Health Records Management </h2>
            <div class="small-quote">
                <blockquote>
                    <p>
                        We will implement robust clinic health records systems to enhance the efficiency of healthcare through fast tracing of records, minimizing lost clinic files and complementing efficient data entry into EMR system.
                    </p>
                </blockquote>
            </div>
        </div>
