...
<main class="body-wrapper">
    ...
    <div class="light-wrapper">
        ...
        <div class="container inner2">
            <h2 class="post-title">Population Health Management </h2>
            <div class="small-quote">
                <blockquote>
                    <p>
                        We will provide clinical Dashboards, comparing performance among clinical components such as HIV, TB, PMTC, EID, RH, across facilities and across sub counties. This approach will support health manager’s benchmark, contextualize and understand healthcare challenges, prioritizing and providing the requisite solutions.
                </blockquote>
            </div>
        </div>
        <!-- /.container -->
