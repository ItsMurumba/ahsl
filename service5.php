...
<main class="body-wrapper">
  ...
  <div class="light-wrapper">
    ...
    <div class="container inner2">
      <h2 class="post-title">County Health Information Management Infrastructure </h2>
      <div class="small-quote">
        <blockquote>
      <p>
        One of the innovative approaches that we can implement, is a real-time updating of reports from the clinic onto facility and sub county health managers computers, providing a real time situational analysis with regards to enrollments, lost to follow ups, EID, drug resistant TB diagnosed. This will provide with critical information enabling immediate action to support improvement of clinical care.
      </p>
        </blockquote>
        </div>
    </div>
