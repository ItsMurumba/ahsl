...
<main class="body-wrapper">
  ...
  <div class="light-wrapper">
    ...
    <div class="container inner2">
      <h2 class="post-title">Quality improvement-Data Demand and information use/CQI cycles </h2>
      <div class="small-quote">
        <blockquote>
      <p>
        Routine use of EMR will support Quality improvement cycles, as key performance indicators can be monitored on a routine basis, providing evidence of care improvement across health facilities.
      </p>
        </blockquote>
        </div>
    </div>
